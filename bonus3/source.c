...

{
  ...
  if ((local_14 == (FILE *)0x0) || (param_1 != 2)) {
    ...
    *(undefined *)((int)local_98 + iVar2) = 0; // this is like (local_98 + 0) = 0 
    fread(local_56,1,0x41,local_14);
    fclose(local_14);
    iVar2 = strcmp((char *)local_98,*(char **)(param_2 + 4)); // will compare if argv[1] is equal to the file opened (local_98) 
    if (iVar2 == 0) {
      execl("/bin/sh","sh",0);
    }
    else {
